    ...
    fn posterize(&self, img: &DynamicImage) -> GrayImage {
        ...
        for y in 0..height {
            for x in 0..width {
                ...
                let posterized = (level * 255 / (levels as u8 - 1)).min(255);
...
pub fn all_fonts() -> &'static [&'static AsciiFont] {
    &[
        &FONT_STANDARD, &FONT_SMALL, &FONT_BLOCK, &FONT_BANNER, &FONT_MINI, &FONT_SHADOW,
        &FONT_SLANT, &FONT_BIG, &FONT_DOOM, &FONT_SCRIPT, &FONT_DIGITAL, &FONT_3D,
        &FONT_BUBBLE, &FONT_GRAFFITI, &FONT_GOTHIC, &FONT_LEAN, &FONT_ISOMETRIC,
        &FONT_STARWARS, &FONT_CYBERLARGE, &FONT_ALLIGATOR, &FONT_ROMAN, &FONT_THICK,
        &FONT_OGRE, &FONT_IVRIT, &FONT_RECTANGLES,
    ]
}
...
fn slant_glyph(ch: char) -> Option<Vec<&'static str>> {
    match ch.to_ascii_uppercase() {
        'A' => Some(vec!["    ___   ", "   /   |  ", "  / /| |  ", " / ___ |  ", "/_/  |_|  ", "          "]),
        'B' => Some(vec!["    ____ ", "   / __ )", "  / __  |", " / /_/ / ", "/_____/  ", "         "]),
        'C' => Some(vec!["   ______", "  / ____/", " / /     ", "/ /___   ", "\\____/   ", "         "]),
        'D' => Some(vec!["    ____ ", "   / __ \\", "  / / / /", " / /_/ / ", "/_____/  ", "         "]),
        'E' => Some(vec!["    ______", "   / ____/", "  / __/   ", " / /___   ", "/_____/   ", "          "]),
        'F' => Some(vec!["    ______", "   / ____/", "  / /_    ", " / __/    ", "/_/       ", "          "]),
        'G' => Some(vec!["   ______", "  / ____/", " / / __  ", "/ /_/ /  ", "\\____/   ", "         "]),
        'H' => Some(vec!["    __  __", "   / / / /", "  / /_/ / ", " / __  /  ", "/_/ /_/   ", "          "]),
        'I' => Some(vec!["    ____", "   /  _/", "   / /  ", " _/ /   ", "/___/   ", "        "]),
        'J' => Some(vec!["       __", "      / /", "  __ / / ", " / /_/ /  ", " \\____/  ", "         "]),
        'K' => Some(vec!["    __ __", "   / //_/", "  / ,<   ", " / /| |  ", "/_/ |_|  ", "         "]),
        'L' => Some(vec!["    __ ", "   / / ", "  / /  ", " / /___", "/_____/", "       "]),
        'M' => Some(vec!["    __  ___", "   /  |/  /", "  / /|_/ / ", " / /  / /  ", "/_/  /_/   ", "           "]),
        'N' => Some(vec!["    _   __", "   / | / /", "  /  |/ / ", " / /|  /  ", "/_/ |_/   ", "          "]),
        'O' => Some(vec!["   ____ ", "  / __ \\", " / / / /", "/ /_/ / ", "\\____/  ", "        "]),
        'P' => Some(vec!["    ____ ", "   / __ \\", "  / /_/ /", " / ____/ ", "/_/      ", "         "]),
        'Q' => Some(vec!["   ____ ", "  / __ \\", " / / / /", "/ /_/ / ", "\\___\\_\\ ", "        "]),
        'R' => Some(vec!["    ____ ", "   / __ \\", "  / /_/ /", " / _, _/ ", "/_/ |_|  ", "         "]),
        'S' => Some(vec!["   _____", "  / ___/", "  \\__ \\ ", " ___/ / ", "/____/  ", "        "]),
        'T' => Some(vec!["  ______", " /_  __/", "  / /   ", " / /    ", "/_/     ", "        "]),
        'U' => Some(vec!["   __  __", "  / / / /", " / / / / ", "/ /_/ /  ", "\\____/   ", "         "]),
        'V' => Some(vec!["   _    __", "  | |  / /", "  | | / / ", "  | |/ /  ", "  |___/   ", "          "]),
        'W' => Some(vec!["  _       __", " | |     / /", " | | /| / / ", " | |/ |/ /  ", " |__/|__/   ", "            "]),
        'X' => Some(vec!["   _  __", "  | |/ /", "  |   / ", " /   |  ", "/_/|_|  ", "        "]),
        'Y' => Some(vec!["__  __", "\\ \\/ /", " \\  / ", " / /  ", "/_/   ", "      "]),
        'Z' => Some(vec!["  _____", " /__  /", "   / / ", "  / /__", " /____/", "       "]),
        ' ' => Some(vec!["    ", "    ", "    ", "    ", "    ", "    "]),
        _ => Some(vec!["    ", " ?? ", "    ", " ?? ", "    ", "    "]),
    }
}
...
fn big_glyph(ch: char) -> Option<Vec<&'static str>> {
    match ch.to_ascii_uppercase() {
        'A' => Some(vec!["          ", "    /\\    ", "   /  \\   ", "  / /\\ \\  ", " / ____ \\ ", "/_/    \\_\\", "          ", "          "]),
        'B' => Some(vec![" ____  ", "|  _ \\ ", "| |_) |", "|  _ < ", "| |_) |", "|____/ ", "       ", "       "]),
        'C' => Some(vec!["  _____ ", " / ____|", "| |     ", "| |     ", "| |____ ", " \\_____|", "        ", "        "]),
        'D' => Some(vec![" _____  ", "|  __ \\ ", "| |  | |", "| |  | |", "| |__| |", "|_____/ ", "        ", "        "]),
        'E' => Some(vec![" ______ ", "|  ____|", "| |__   ", "|  __|  ", "| |____ ", "|______|", "        ", "        "]),
        'F' => Some(vec![" ______ ", "|  ____|", "| |__   ", "|  __|  ", "| |     ", "|_|     ", "        ", "        "]),
        'G' => Some(vec!["  _____ ", " / ____|", "| |  __ ", "| | |_ |", "| |__| |", " \\_____|", "        ", "        "]),
        'H' => Some(vec![" _    _ ", "| |  | |", "| |__| |", "|  __  |", "| |  | |", "|_|  |_|", "        ", "        "]),
        'I' => Some(vec![" _____ ", "|_   _|", "  | |  ", "  | |  ", " _| |_ ", "|_____|", "       ", "       "]),
        'J' => Some(vec!["      _ ", "     | |", "     | |", " _   | |", "| |__| |", " \\____/ ", "        ", "        "]),
        'K' => Some(vec![" _  __", "| |/ /", "| ' / ", "|  <  ", "| . \\ ", "|_|\\_\\", "      ", "      "]),
        'L' => Some(vec![" _      ", "| |     ", "| |     ", "| |     ", "| |____ ", "|______|", "        ", "        "]),
        'M' => Some(vec![" __  __ ", "|  \\/  |", "| \\  / |", "| |\\/| |", "| |  | |", "|_|  |_|", "        ", "        "]),
        'N' => Some(vec![" _   _ ", "| \\ | |", "|  \\| |", "| . ` |", "| |\\  |", "|_| \\_|", "       ", "       "]),
        'O' => Some(vec!["  ____  ", " / __ \\ ", "| |  | |", "| |  | |", "| |__| |", " \\____/ ", "        ", "        "]),
        'P' => Some(vec![" _____  ", "|  __ \\ ", "| |__) |", "|  ___/ ", "| |     ", "|_|     ", "        ", "        "]),
        'Q' => Some(vec!["  ____  ", " / __ \\ ", "| |  | |", "| |  | |", "| |__| |", " \\___\\_\\", "        ", "        "]),
        'R' => Some(vec![" _____  ", "|  __ \\ ", "| |__) |", "|  _  / ", "| | \\ \\ ", "|_|  \\_\\", "        ", "        "]),
        'S' => Some(vec!["  _____ ", " / ____|", "| (___  ", " \\___ \\ ", " ____) |", "|_____/ ", "        ", "        "]),
        'T' => Some(vec![" _______ ", "|__   __|", "   | |   ", "   | |   ", "   | |   ", "   |_|   ", "         ", "         "]),
        'U' => Some(vec![" _    _ ", "| |  | |", "| |  | |", "| |  | |", "| |__| |", " \\____/ ", "        ", "        "]),
        'V' => Some(vec!["__      __", "\\ \\    / /", " \\ \\  / / ", "  \\ \\/ /  ", "   \\  /   ", "    \\/    ", "          ", "          "]),
        'W' => Some(vec!["__          __", "\\ \\        / /", " \\ \\  /\\  / / ", "  \\ \\/  \\/ /  ", "   \\  /\\  /   ", "    \\/  \\/    ", "              ", "              "]),
        'X' => Some(vec!["__   __", "\\ \\ / /", " \\ V / ", "  > <  ", " / . \\ ", "/_/ \\_\\", "       ", "       "]),
        'Y' => Some(vec!["__     __", "\\ \\   / /", " \\ \\_/ / ", "  \\   /  ", "   | |   ", "   |_|   ", "         ", "         "]),
        'Z' => Some(vec![" ______", "|___  /", "   / / ", "  / /  ", " / /__ ", "/_____|", "       ", "       "]),
        ' ' => Some(vec!["    ", "    ", "    ", "    ", "    ", "    ", "    ", "    "]),
        _ => Some(vec!["    ", "    ", " ?? ", "    ", " ?? ", "    ", "    ", "    "]),
    }
}
...
fn doom_glyph(ch: char) -> Option<Vec<&'static str>> {
    match ch.to_ascii_uppercase() {
        'A' => Some(vec!["        ", "   /\\   ", "  /  \\  ", " / /\\ \\ ", "/______\\", "\\      /", " \\    / ", "  \\__/  "]),
        'B' => Some(vec!["______  ", "| ___ \\ ", "| |_/ / ", "| ___ \\ ", "| |_/ / ", "|_____/ ", "        ", "        "]),
        'C' => Some(vec![" _____ ", "/  __ \\", "| /  \\|", "| |    ", "| \\__/|", " \\____/", "       ", "       "]),
        'D' => Some(vec!["______  ", "|  _  \\ ", "| | | | ", "| | | | ", "| |/ /  ", "|___/   ", "        ", "        "]),
        'E' => Some(vec!["_______ ", "|  ___| ", "| |__   ", "|  __|  ", "| |___  ", "|_____| ", "        ", "        "]),
        'F' => Some(vec!["_______ ", "|  ___| ", "| |__   ", "|  __|  ", "| |     ", "|_|     ", "        ", "        "]),
        'G' => Some(vec![" _____ ", "/  __ \\", "| |  \\|", "| | __ ", "| |_\\ \\", " \\____/", "       ", "       "]),
        'H' => Some(vec!["_   _  ", "| | | | ", "| |_| | ", "|  _  | ", "| | | | ", "|_| |_| ", "        ", "        "]),
        'I' => Some(vec!["_____ ", "|_   _|", "  | |  ", "  | |  ", " _| |_ ", "|_____|", "       ", "       "]),
        'J' => Some(vec!["    _ ", "   | | ", "   | | ", "   | | ", "/\\__/ / ", "\\____/  ", "        ", "        "]),
        'K' => Some(vec!["_   __", "| | / /", "| |/ / ", "|    \\ ", "| |\\  \\", "|_| \\_\\", "       ", "       "]),
        'L' => Some(vec!["_     ", "| |    ", "| |    ", "| |    ", "| |___ ", "|_____|", "       ", "       "]),
        'M' => Some(vec!["___  ___", "|  \\/  |", "| .  . |", "| |\\/| |", "| |  | |", "\\_|  |_/", "        ", "        "]),
        'N' => Some(vec!["_   _ ", "| \\ | |", "|  \\| |", "| . ` |", "| |\\  |", "\\_| \\_/", "       ", "       "]),
        'O' => Some(vec![" _____ ", "/  _  \\", "| | | |", "| | | |", "| |_| |", "\\_____/", "       ", "       "]),
        'P' => Some(vec!["______ ", "| ___ \\", "| |_/ /", "|  __/ ", "| |    ", "\\_|    ", "       ", "       "]),
        'Q' => Some(vec![" _____ ", "/  _  \\", "| | | |", "| |_| |", " \\___\\\\", "     \\_\\", "       ", "       "]),
        'R' => Some(vec!["______ ", "| ___ \\", "| |_/ /", "|    / ", "| |\\ \\ ", "\\_| \\_\\", "       ", "       "]),
        'S' => Some(vec![" _____ ", "/  ___|", "\\ `--. ", " `--. \\", "/\\__/ /", "\\____/ ", "       ", "       "]),
        'T' => Some(vec!["_______", "|_   _|", "  | |  ", "  | |  ", "  | |  ", "  \\_/  ", "       ", "       "]),
        'U' => Some(vec!["_   _ ", "| | | |", "| | | |", "| | | |", "| |_| |", " \\___/ ", "       ", "       "]),
        'V' => Some(vec!["_   _ ", "| | | |", "| | | |", "| \\ / |", " \\ V / ", "  \\_/  ", "       ", "       "]),
        'W' => Some(vec!["_    _  ", "| |  | | ", "| |  | | ", "| |/\\| | ", "\\  /\\  / ", " \\/  \\/  ", "         ", "         "]),
        'X' => Some(vec!["__   __", "\\ \\ / /", " \\ V / ", " /   \\ ", "/ /^\\ \\", "\\/   \\/", "       ", "       "]),
        'Y' => Some(vec!["__   __", "\\ \\ / /", " \\ V / ", "  \\ /  ", "  | |  ", "  \\_/  ", "       ", "       "]),
        'Z' => Some(vec!["_______", "|___  /", "   / / ", "  / /  ", "./ /___", "/_____/", "       ", "       "]),
        ' ' => Some(vec!["    ", "    ", "    ", "    ", "    ", "    ", "    ", "    "]),
        _ => Some(vec!["    ", "    ", " ?? ", "    ", " ?? ", "    ", "    ", "    "]),
    }
}
...
fn font_3d_glyph(ch: char) -> Option<Vec<&'static str>> {
    match ch.to_ascii_uppercase() {
        'A' => Some(vec!["    ___    ", "   /   |   ", "  / /| |   ", " / ___ |   ", "/_/  |_|__ ", "     /____|", "           "]),
        'B' => Some(vec!["  ______  ", " |  ___ \\ ", " | |___) |", " |  ___  <", " | |___) |", " |______/ ", "          "]),
        'C' => Some(vec!["  _______ ", " / _____/ ", "| |       ", "| |       ", "| |_____  ", " \\_____/  ", "          "]),
        'D' => Some(vec!["  _____   ", " |  __ \\  ", " | |  \\ \\ ", " | |   | |", " | |__/ / ", " |_____/  ", "          "]),
        'E' => Some(vec!["  _______ ", " |  _____|", " | |__    ", " |  __|   ", " | |_____ ", " |_______|", "          "]),
        'F' => Some(vec!["  _______ ", " |  _____|", " | |__    ", " |  __|   ", " | |      ", " |_|      ", "          "]),
        'G' => Some(vec!["  _______ ", " / _____/ ", "| |   __  ", "| |  |_ | ", "| |___| | ", " \\_____/  ", "          "]),
        'H' => Some(vec!["  _   _   ", " | | | |  ", " | |_| |  ", " |  _  |  ", " | | | |  ", " |_| |_|  ", "          "]),
        'I' => Some(vec!["  _____ ", " |_   _|", "   | |  ", "   | |  ", "  _| |_ ", " |_____|", "        "]),
        'J' => Some(vec!["       __ ", "      |  |", "      |  |", "  __  |  |", " |  |_|  |", " |_______/", "          "]),
        'K' => Some(vec!["  _  __   ", " | |/ /   ", " | ' /    ", " |  <     ", " | . \\    ", " |_|\\_\\   ", "          "]),
        'L' => Some(vec!["  _       ", " | |      ", " | |      ", " | |      ", " | |_____ ", " |_______|", "          "]),
        'M' => Some(vec!["  __    __ ", " |  \\  /  |", " |   \\/   |", " | |\\  /| |", " | | \\/ | |", " |_|    |_|", "           "]),
        'N' => Some(vec!["  _     _ ", " | \\   | |", " |  \\  | |", " |   \\ | |", " | |\\ \\| |", " |_| \\___/", "          "]),
        'O' => Some(vec!["  ______  ", " / ____ \\ ", "| |    | |", "| |    | |", "| |____| |", " \\______/ ", "          "]),
        'P' => Some(vec!["  ______  ", " |  ___ \\ ", " | |___) |", " |  ____/ ", " | |      ", " |_|      ", "          "]),
        'Q' => Some(vec!["  ______  ", " / ____ \\ ", "| |    | |", "| |  _ | |", "| |_| \\| |", " \\_____\\_\\", "          "]),
        'R' => Some(vec!["  ______  ", " |  ___ \\ ", " | |___) |", " |  _  _/ ", " | | \\ \\  ", " |_|  \\_\\ ", "          "]),
        'S' => Some(vec!["  _______ ", " / ____  |", "| (___  | ", " \\___ \\ | ", " ____) | |", "|________|", "          "]),
        'T' => Some(vec!["  ________ ", " |__  ____|", "    | |    ", "    | |    ", "    | |    ", "    |_|    ", "           "]),
        'U' => Some(vec!["  _     _ ", " | |   | |", " | |   | |", " | |   | |", " | |___| |", "  \\_____/ ", "          "]),
        'V' => Some(vec!["  _     _ ", " | |   | |", " | |   | |", "  \\ \\ / / ", "   \\ V /  ", "    \\_/   ", "          "]),
        'W' => Some(vec!["  _       _ ", " | |     | |", " | |     | |", " |  \\ _ /  |", "  \\ |_| /  ", "   |___|   ", "           "]),
        'X' => Some(vec!["  _     _ ", "  \\ \\   / /", "   \\ \\_/ / ", "    > < /  ", "   / /\\ \\  ", "  /_/  \\_\\ ", "          "]),
        'Y' => Some(vec!["  _     _ ", "  \\ \\   / /", "   \\ \\_/ / ", "    \\   /  ", "     | |   ", "     |_|   ", "          "]),
        'Z' => Some(vec!["  ________ ", " |______  |", "       / / ", "      / /  ", "     / /__ ", "    /_____|", "          "]),
        ' ' => Some(vec!["     ", "     ", "     ", "     ", "     ", "     ", "     "]),
        _ => Some(vec!["     ", " ??? ", "     ", " ??? ", "     ", "     ", "     "]),
    }
}
...
fn gothic_glyph(ch: char) -> Option<Vec<&'static str>> {
    match ch.to_ascii_uppercase() {
        'A' => Some(vec!["     _     ", "    /_\\    ", "   //_\\\\   ", "  //___\\\\  ", " //     \\\\ ", "//       \\\\"]),
        'B' => Some(vec!["_______ ", "||___  \\", "||    ) )", "||___  / ", "||    ) )", "||____/ "]),
        'C' => Some(vec!["  _____ ", " / ____\\", "| |     ", "| |     ", "| |____ ", " \\_____/"]),
        'D' => Some(vec!["______  ", "||    \\ ", "||     \\", "||     /", "||    / ", "||___/  "]),
        'E' => Some(vec!["_______ ", "||_____|", "||___   ", "||___   ", "||_____ ", "||_____|"]),
        'F' => Some(vec!["_______ ", "||_____|", "||___   ", "||___   ", "||      ", "||      "]),
        'G' => Some(vec!["  _____ ", " / ____\\", "| |  __ ", "| | |_ |", "| |__| |", " \\_____/"]),
        'H' => Some(vec!["||   || ", "||   || ", "||___|| ", "||---|| ", "||   || ", "||   || "]),
        'I' => Some(vec!["______", " _||_ ", "  ||  ", "  ||  ", " _||_ ", "______"]),
        'J' => Some(vec!["  ____ ", "   || ", "   || ", "   || ", "|\\_|| ", " \\__/ "]),
        'K' => Some(vec!["||  //", "|| // ", "||//  ", "||\\\\  ", "|| \\\\ ", "||  \\\\"]),
        'L' => Some(vec!["||     ", "||     ", "||     ", "||     ", "||____ ", "||_____|"]),
        'M' => Some(vec!["||\\  /||", "|| \\/ ||", "||    ||", "||    ||", "||    ||", "||    ||"]),
        'N' => Some(vec!["||\\   ||", "|| \\  ||", "||  \\ ||", "||   \\||", "||    ||", "||    ||"]),
        'O' => Some(vec!["  ____  ", " /    \\ ", "||    ||", "||    ||", "||    ||", " \\____/ "]),
        'P' => Some(vec!["______  ", "||    \\ ", "||____/ ", "||      ", "||      ", "||      "]),
        'Q' => Some(vec!["  ____  ", " /    \\ ", "||    ||", "||  \\ ||", "||   \\||", " \\____\\\\"]),
        'R' => Some(vec!["______  ", "||    \\ ", "||____/ ", "||  \\   ", "||   \\  ", "||    \\ "]),
        'S' => Some(vec![" _____  ", "/  ___| ", "\\___ \\  ", "  ___)| ", " \\___/  ", "        "]),
        'T' => Some(vec!["________", "  _||_  ", "   ||   ", "   ||   ", "   ||   ", "   ||   "]),
        'U' => Some(vec!["||    ||", "||    ||", "||    ||", "||    ||", "||    ||", " \\____/ "]),
        'V' => Some(vec!["||    ||", "||    ||", " \\\\  // ", "  \\\\//  ", "   \\/   ", "        "]),
        'W' => Some(vec!["||    ||", "||    ||", "|| /\\ ||", "||/  \\||", "||    ||", "        "]),
        'X' => Some(vec!["\\\\    //", " \\\\  // ", "  \\\\//  ", "  //\\\\  ", " //  \\\\ ", "//    \\\\"]),
        'Y' => Some(vec!["\\\\    //", " \\\\  // ", "  \\\\//  ", "   ||   ", "   ||   ", "   ||   "]),
        'Z' => Some(vec!["________", "______//", "    //  ", "  //    ", "//______", "________|"]),
        ' ' => Some(vec!["    ", "    ", "    ", "    ", "    ", "    "]),
        _ => Some(vec!["    ", " ?? ", "    ", " ?? ", "    ", "    "]),
    }
}
...
fn lean_glyph(ch: char) -> Option<Vec<&'static str>> {
    match ch.to_ascii_uppercase() {
        'A' => Some(vec!["    _/_/    ", "   _/  _/   ", "  _/_/_/_/  ", " _/    _/   ", "_/      _/  "]),
        'B' => Some(vec!["  _/_/_/   ", " _/    _/  ", "_/_/_/_/   ", "_/    _/   ", "_/_/_/     "]),
        'C' => Some(vec!["  _/_/_/_/ ", " _/        ", "_/         ", "_/         ", " _/_/_/_/  "]),
        'D' => Some(vec!["  _/_/_/   ", " _/    _/  ", "_/      _/ ", "_/    _/   ", "_/_/_/     "]),
        'E' => Some(vec!["  _/_/_/_/_/", " _/         ", "_/_/_/_/    ", "_/          ", "_/_/_/_/_/  "]),
        'F' => Some(vec!["  _/_/_/_/_/", " _/         ", "_/_/_/_/    ", "_/          ", "_/          "]),
        'G' => Some(vec!["  _/_/_/_/ ", " _/        ", "_/   _/_/  ", "_/      _/ ", " _/_/_/_/  "]),
        'H' => Some(vec!["  _/    _/  ", " _/    _/   ", "_/_/_/_/_/  ", "_/      _/  ", "_/      _/  "]),
        'I' => Some(vec!["  _/_/_/_/", "     _/   ", "    _/    ", "   _/     ", "_/_/_/_/  "]),
        'J' => Some(vec!["      _/_/", "        _/", "       _/ ", "      _/  ", "_/_/_/    "]),
        'K' => Some(vec!["  _/  _/  ", " _/ _/    ", "_/_/      ", "_/  _/    ", "_/    _/  "]),
        'L' => Some(vec!["  _/       ", " _/        ", "_/         ", "_/         ", "_/_/_/_/_/ "]),
        'M' => Some(vec!["  _/      _/  ", " _/_/  _/_/   ", "_/  _/_/  _/  ", "_/        _/  ", "_/        _/  "]),
        'N' => Some(vec!["  _/      _/ ", " _/_/    _/  ", "_/  _/  _/   ", "_/    _/_/   ", "_/      _/   "]),
        'O' => Some(vec!["   _/_/_/  ", "  _/    _/ ", " _/      _/", "_/      _/ ", " _/_/_/    "]),
        'P' => Some(vec!["  _/_/_/   ", " _/    _/  ", "_/_/_/     ", "_/         ", "_/         "]),
        'Q' => Some(vec!["   _/_/_/  ", "  _/    _/ ", " _/      _/", "_/    _/_/ ", " _/_/_/ _/ "]),
        'R' => Some(vec!["  _/_/_/   ", " _/    _/  ", "_/_/_/     ", "_/   _/    ", "_/     _/  "]),
        'S' => Some(vec!["  _/_/_/_/ ", " _/        ", " _/_/_/    ", "      _/   ", "_/_/_/     "]),
        'T' => Some(vec!["_/_/_/_/_/_/", "     _/     ", "    _/      ", "   _/       ", "  _/        "]),
        'U' => Some(vec!["  _/      _/", " _/      _/ ", "_/      _/  ", "_/    _/    ", " _/_/_/     "]),
        'V' => Some(vec!["  _/        _/", " _/        _/ ", "_/        _/  ", " _/      _/   ", "  _/_/_/_/    "]),
        'W' => Some(vec!["  _/          _/", " _/          _/ ", "_/    _/    _/  ", " _/  _/ _/ _/   ", "  _/      _/    "]),
        'X' => Some(vec!["  _/      _/", "   _/  _/   ", "    _/_/    ", "   _/  _/   ", "  _/    _/  "]),
        'Y' => Some(vec!["  _/      _/", "   _/  _/   ", "    _/_/    ", "     _/     ", "    _/      "]),
        'Z' => Some(vec!["_/_/_/_/_/_/", "       _/   ", "    _/      ", " _/         ", "_/_/_/_/_/_/"]),
        ' ' => Some(vec!["     ", "     ", "     ", "     ", "     "]),
        _ => Some(vec!["     ", " ??? ", "     ", " ??? ", "     "]),
    }
}
...
fn isometric_glyph(ch: char) -> Option<Vec<&'static str>> {
    match ch.to_ascii_uppercase() {
        'A' => Some(vec!["      ___     ", "     /\\  \\    ", "    /::\\  \\   ", "   /:/\\:\\  \\  ", "  /:/_\\:\\__\\ ", " /:/ `\\/__/ ", " \\/__/       "]),
        'B' => Some(vec!["   ___     ", "  /\\  \\    ", " |::\\  \\   ", " |:|:\\  \\  ", " |:| \\:\\__\\", " |:|  \\/__/", "  \\|__|     "]),
        'C' => Some(vec!["      ___   ", "     /\\__\\  ", "    /:/  /  ", "   /:/  /   ", "  /:/  /    ", " /:/__/     ", " \\/__/      "]),
        'D' => Some(vec!["   ___      ", "  /\\  \\     ", " |::\\  \\    ", " |:|:\\  \\   ", " |:| \\:\\__\\ ", " |:|  \\/__/ ", "  \\|__|      "]),
        'E' => Some(vec!["   _____   ", "  /\\  ___ \\ ", " |::\\/___/|", " |:::_____/", " |:::\\____\\", "  \\::/__/  ", "   \\/__/    "]),
        'F' => Some(vec!["   _____   ", "  /\\  ___ \\ ", " |::\\/___/|", " |::_____/ ", " |::|      ", "  \\|__|     ", "            "]),
        'G' => Some(vec!["      ____  ", "     /\\  __\\", "    |::|\\_\\|", "    |:|  __ ", "    |::|\\_\\|", "     \\:|\\_\\|", "      \\|__| "]),
        'H' => Some(vec!["   ___  ___ ", "  /\\  \\/\\  \\", " |::| |::| |", " |::|_|::| |", " |:::::/__/ ", " |::::|____ ", "  \\|__|     "]),
        'I' => Some(vec!["   _____ ", "  /\\__  \\", " |::| | |", " |::| | |", " |::| | |", " |::|_|/ ", "  \\/__/  "]),
        'J' => Some(vec!["     _____ ", "    /\\__  \\", "   /::| | |", "  /::/ | | ", " /::/__| | ", " \\:\\/___/ ", "  \\/__/    "]),
        'K' => Some(vec!["   ___  ___", "  /\\  \\/\\__\\", " |::|_\\:| |", " |:::__::| ", " |:|  |::| ", " |:|__|::| ", "  \\/__/    "]),
        'L' => Some(vec!["   ___     ", "  /\\  \\    ", " |::\\  \\   ", " |::\\  \\   ", " |::\\  \\   ", " |::::\\___\\", "  \\/__/    "]),
        'M' => Some(vec!["   ___ ___  ", "  /\\__/\\__\\ ", " |:| |:| | |", " |:| |:| | |", " |:|_|:|_| |", "  \\/_/\\/_/ /", "    \\/__/   "]),
        'N' => Some(vec!["   ___  ___ ", "  /\\__\\/\\  \\", " |::\\ \\::\\ \\", " |::\\ \\::\\  \\", " |::\\ \\::/__/", "  \\::\\/:/   ", "   \\/__/     "]),
        'O' => Some(vec!["      ___   ", "     /\\  \\  ", "    /::\\  \\ ", "   /:/\\:\\  \\", "  /:/ /::\\__\\", " /:/_/:/ /  ", " \\/__/::/   "]),
        'P' => Some(vec!["   _____  ", "  /\\  __ \\ ", " |::|___ \\|", " |:::____/ ", " |::|      ", " |::|      ", "  \\|__|     "]),
        'Q' => Some(vec!["      ___   ", "     /\\  \\  ", "    /::\\  \\ ", "   /:/\\:\\  \\", "  /:/ /::\\__\\", " /:/_/:/ _/ ", " \\:\\ \\/_/   "]),
        'R' => Some(vec!["   _____  ", "  /\\  __ \\ ", " |::|___ \\|", " |:::____/ ", " |::|_/ /  ", " |::/ /    ", "  \\/__/     "]),
        'S' => Some(vec!["      ___   ", "     /\\__\\  ", "    /:/ _/_ ", "   /:/ /\\__\\", "  /:/ /:/__/", " /:/_/::\\ \\ ", " \\/__/\\/__/ "]),
        'T' => Some(vec!["  _________ ", " /\\________\\", " \\/___ __::/", "     |::| / ", "    /:::|/  ", "   /:::/    ", "   \\/__/    "]),
        'U' => Some(vec!["   ___  ___ ", "  /\\  \\/\\  \\", " |::| |::| |", " |::| |::| |", " |::\\_/::/ /", "  \\::/\\/__/ ", "   \\/__/    "]),
        'V' => Some(vec!["  ___    ___ ", " /\\  \\  /\\  \\", " \\:\\  \\/:\\  \\", "  \\:\\__\\:\\__\\", "   \\/__/\\_\\/ ", "        \\/_/ ", "             "]),
        'W' => Some(vec!["  ___  ___  ___ ", " /\\  \\/\\  \\/\\  \\", " \\:\\  \\:\\  \\:\\  \\", "  \\:\\__\\:\\__\\:\\__\\", "   \\/__/\\_\\:\\/__/", "        /:/\\/__/ ", "        \\/__/    "]),
        'X' => Some(vec!["   ___  ___ ", "  /\\  \\/\\  \\", "  \\:\\::\\ \\:\\ ", "   \\:/::\\__\\", "   /:/\\/__/", "  /:/  /   ", "  \\/__/    "]),
        'Y' => Some(vec!["  ___    ___ ", " /\\  \\  /\\  \\", " \\:\\  \\/:\\__\\", "  \\:\\__::/  /", "   \\/_/:/  / ", "     /:/  /  ", "     \\/__/   "]),
        'Z' => Some(vec!["  _________ ", " /\\________\\", " \\/___ __::/", "  /:/\\::/ / ", " /:/\\::/ /  ", " \\/__\\/__/  ", "            "]),
        ' ' => Some(vec!["      ", "      ", "      ", "      ", "      ", "      ", "      "]),
        _ => Some(vec!["      ", " ???? ", "      ", " ???? ", "      ", "      ", "      "]),
    }
}
...
fn starwars_glyph(ch: char) -> Option<Vec<&'static str>> {
    match ch.to_ascii_uppercase() {
        'A' => Some(vec![".     ", "|     ", "|___  ", "|   | ", "|   | ", "      "]),
        'B' => Some(vec!["____  ", "|   \\ ", "|___/ ", "|   \\ ", "|___/ ", "      "]),
        'C' => Some(vec![" ____ ", "/    |", "|     ", "|     ", "\\____|", "      "]),
        'D' => Some(vec!["____  ", "|   \\ ", "|    |", "|   / ", "|___/ ", "      "]),
        'E' => Some(vec!["_____ ", "|     ", "|__   ", "|     ", "|____ ", "      "]),
        'F' => Some(vec!["_____ ", "|     ", "|__   ", "|     ", "|     ", "      "]),
        'G' => Some(vec![" ____ ", "/    |", "| __ |", "|   ||", "\\___/|", "      "]),
        'H' => Some(vec!["|   | ", "|   | ", "|___| ", "|   | ", "|   | ", "      "]),
        'I' => Some(vec!["_____ ", "  |   ", "  |   ", "  |   ", "__|__ ", "      "]),
        'J' => Some(vec!["  ___ ", "    | ", "    | ", "|   | ", " \\__/ ", "      "]),
        'K' => Some(vec!["|   / ", "|  /  ", "|-<   ", "|  \\  ", "|   \\ ", "      "]),
        'L' => Some(vec!["|     ", "|     ", "|     ", "|     ", "|____ ", "      "]),
        'M' => Some(vec!["|\\  /|", "| \\/ |", "|    |", "|    |", "|    |", "      "]),
...
fn cyberlarge_glyph(ch: char) -> Option<Vec<&'static str>> {
    match ch.to_ascii_uppercase() {
        'A' => Some(vec!["   /\\   ", "  /  \\  ", " / /\\ \\ ", "/ /__\\ \\", "\\        \\", "         "]),
        'B' => Some(vec!["______  ", "| ___ \\ ", "| |_/ / ", "| ___ \\ ", "| |_/ / ", "|_____/ "]),
        'C' => Some(vec!["  _____ ", " / ___ \\", "| |   |_|", "| |      ", "| |___   ", " \\_____\\ "]),
        'D' => Some(vec!["______  ", "|  _  \\ ", "| | | | ", "| |_| | ", "|_____/ ", "        "]),
        'E' => Some(vec!["_______ ", "|  ___| ", "| |___  ", "|  ___| ", "| |___  ", "|_____| "]),
        'F' => Some(vec!["_______ ", "|  ___| ", "| |___  ", "|  ___| ", "| |     ", "|_|     "]),
        'G' => Some(vec!["  _____ ", " / ___ \\", "| |   |_|", "| |  __ ", "| |__|  |", " \\______/"]),
        'H' => Some(vec!["_     _ ", "| |   | |", "| |___| |", "|  ___  |", "| |   | |", "|_|   |_|"]),
        'I' => Some(vec!["_____ ", "|_   _|", "  | |  ", "  | |  ", " _| |_ ", "|_____|"]),
        'J' => Some(vec!["    _ ", "   | |", "   | |", "_  | |", "| |_| |", " \\___/ "]),
        'K' => Some(vec!["_   __", "| | / /", "| |/ / ", "|   <  ", "| |\\ \\ ", "|_| \\_\\"]),
        'L' => Some(vec!["_      ", "| |     ", "| |     ", "| |     ", "| |___  ", "|______/"]),
        'M' => Some(vec!["__    __", "|\\ \\  / /|", "| \\ \\/ / |", "|  \\  /  |", "|   \\/   |", "|        |"]),
        'N' => Some(vec!["_     _ ", "| \\   | |", "|  \\  | |", "|   \\ | |", "|    \\| |", "|     \\_|"]),
        'O' => Some(vec!["  ____  ", " / __ \\ ", "| |  | |", "| |  | |", "| |__| |", " \\____/ "]),
        'P' => Some(vec!["______  ", "| ___ \\ ", "| |_/ / ", "|  __/  ", "| |     ", "|_|     "]),
        'Q' => Some(vec!["  ____  ", " / __ \\ ", "| |  | |", "| |  | |", "| |_\\| |", " \\___\\_\\"]),
        'R' => Some(vec!["______  ", "| ___ \\ ", "| |_/ / ", "|    /  ", "| |\\ \\  ", "|_| \\_\\ "]),
        'S' => Some(vec!["  ____ ", " / ___|", "| \\___ ", " \\___  \\", " ___/ /", "|____/ "]),
        'T' => Some(vec!["_______ ", "|__   __|", "   | |   ", "   | |   ", "   | |   ", "   |_|   "]),
        'U' => Some(vec!["_     _ ", "| |   | |", "| |   | |", "| |   | |", "| |___| |", " \\_____/ "]),
        'V' => Some(vec!["_     _ ", "| |   | |", "| |   | |", " \\ \\ / / ", "  \\ V /  ", "   \\_/   "]),
        'W' => Some(vec!["_       _ ", "| |     | |", "| |  _  | |", "| | / \\ | |", "| |/ / \\| |", "|___/ \\___|"]),
        'X' => Some(vec!["_     _ ", " \\ \\ / / ", "  \\ V /  ", "   > <   ", "  / . \\  ", " /_/ \\_\\ "]),
        'Y' => Some(vec!["_     _ ", " \\ \\ / / ", "  \\ V /  ", "   | |   ", "   | |   ", "   |_|   "]),
        'Z' => Some(vec!["_______ ", "|__   __|", "   / /   ", "  / /    ", " / /___  ", "|_______|"]),
        ' ' => Some(vec!["    ", "    ", "    ", "    ", "    ", "    "]),
        _ => Some(vec!["    ", " ?? ", "    ", " ?? ", "    ", "    "]),
    }
}
...
fn roman_glyph(ch: char) -> Option<Vec<&'static str>> {
    match ch.to_ascii_uppercase() {
        'A' => Some(vec![".oOOOo.  ", ".O    o  ", "o      O ", "O.    .O ", " oOooOoOo", "       O "]),
        'B' => Some(vec!["OOOoOoo. ", "o     `O ", "O      o ", "o     .O ", "OOooOoo' ", "         "]),
        'C' => Some(vec!["  .oOOOo. ", " .O    o. ", " o        ", " o        ", " `OoooooO'", "          "]),
        'D' => Some(vec!["OOOoOoo. ", "o     `O ", "O      o ", "o     .O ", "OOooOoo' ", "         "]),
        'E' => Some(vec!["OOooOooO", "o       ", "O       ", "o       ", "OOooOooO", "        "]),
        'F' => Some(vec!["OOooOooO", "o       ", "O       ", "o       ", "O       ", "        "]),
        'G' => Some(vec!["  .oOOOo. ", " .O    o  ", " o      O ", " O.    .O ", " `oOooOoo ", "        O "]),
        'H' => Some(vec!["o      O", "O      o", "oOooOOoo", "O      O", "o      o", "        "]),
        'I' => Some(vec!["oOoOOoOo", "   o    ", "   O    ", "   o    ", "oOoOOoOo", "        "]),
        'J' => Some(vec!["      O", "      o", "      O", "o    .O", "`oooO' ", "       "]),
        'K' => Some(vec!["o   .O ", "O  .o  ", "oOo    ", "O  `o  ", "o   .O ", "       "]),
        'L' => Some(vec!["o      ", "O      ", "o      ", "O      ", "OooOOoo", "       "]),
        'M' => Some(vec!["O     o ", "Oo   oO ", "O O O o ", "o  `o  O", "O     O ", "        "]),
        'N' => Some(vec!["o\\    o ", "O `o  O ", "o  `O o ", "O   `oO ", "O     o ", "        "]),
        'O' => Some(vec!["  .oOOOo. ", " .O    Oo ", " o      O ", " O      o ", " `OoooOO' ", "          "]),
        'P' => Some(vec!["OOOoOoo.", "O     `o", "o     .O", "OOooOO' ", "o       ", "        "]),
        'Q' => Some(vec!["  .oOOOo.  ", " .O    oO  ", " o      O  ", " O    oO' O", " `OoooOO  o", "           "]),
        'R' => Some(vec!["OOOoOoo. ", "O     `O ", "o     .O ", "OOooOO'  ", "o    `o  ", "         "]),
        'S' => Some(vec!["  .oOOOo.", " .O    o ", " `o      ", " .oOoO'  ", "o     .o ", "         "]),
        'T' => Some(vec!["oOoOOoOOo", "    o    ", "    O    ", "    o    ", "    O    ", "         "]),
        'U' => Some(vec!["o      O", "O      o", "o      O", "O      o", " oOooOo ", "        "]),
        'V' => Some(vec!["O      o", "o      O", " O    o ", "  o  O  ", "   Oo   ", "        "]),
        'W' => Some(vec!["O          o", "o          O", "O   .Oo.   o", " o.O'  'O.o ", "  O'    'O  ", "            "]),
        'X' => Some(vec!["o     O", " O   o ", "  oOo  ", " O   o ", "o     O", "       "]),
        'Y' => Some(vec!["o     O", " O   o ", "  ooo  ", "   O   ", "   o   ", "       "]),
        'Z' => Some(vec!["OooOOoo", "     o ", "   .O  ", "  oOo  ", "OOOooOO", "       "]),
        ' ' => Some(vec!["    ", "    ", "    ", "    ", "    ", "    "]),
        _ => Some(vec!["    ", " ?? ", "    ", " ?? ", "    ", "    "]),
    }
}
...
fn thick_glyph(ch: char) -> Option<Vec<&'static str>> {
    match ch.to_ascii_uppercase() {
        'A' => Some(vec!["   AA   ", "  AAAA  ", " AA  AA ", " AAAAAA ", "AA    AA"]),
        ...
        'M' => Some(vec!["MM    MM", "MMM  MMM", "MM MM MM", "MM    MM", "MM    MM"]),
        ...
        'W' => Some(vec!["WW    WW", "WW    WW", "WW WW WW", "WWW  WWW", "WW    WW"]),
...
fn ogre_glyph(ch: char) -> Option<Vec<&'static str>> {
    match ch.to_ascii_uppercase() {
        'A' => Some(vec!["        _ ", "       / \\", "      / _ \\", "     / ___ \\", "    /_/   \\_\\", "            ", "            "]),
        'B' => Some(vec!["  ____  ", " | __ ) ", " |  _ \\ ", " | |_) |", " |____/ ", "        ", "        "]),
        'C' => Some(vec!["   ____ ", "  / ___|", " | |    ", " | |___ ", "  \\____|", "        ", "        "]),
        'D' => Some(vec!["  ____  ", " |  _ \\ ", " | | | |", " | |_| |", " |____/ ", "        ", "        "]),
        'E' => Some(vec!["  _____ ", " | ____|", " |  _|  ", " | |___ ", " |_____|", "        ", "        "]),
        'F' => Some(vec!["  _____ ", " |  ___|", " | |_   ", " |  _|  ", " |_|    ", "        ", "        "]),
        'G' => Some(vec!["   ____ ", "  / ___|", " | |  _ ", " | |_| |", "  \\____|", "        ", "        "]),
        'H' => Some(vec!["  _   _ ", " | | | |", " | |_| |", " |  _  |", " |_| |_|", "        ", "        "]),
        'I' => Some(vec!["  ___ ", " |_ _|", "  | | ", "  | | ", " |___|", "      ", "      "]),
        'J' => Some(vec!["      _ ", "     | |", "  _  | |", " | |_| |", "  \\___/ ", "        ", "        "]),
        'K' => Some(vec!["  _  __", " | |/ /", " | ' / ", " | . \\ ", " |_|\\_\\", "       ", "       "]),
        ...
        'M' => Some(vec!["  __  __ ", " |  \\/  |", " | |\\/| |", " | |  | |", " |_|  |_|", "         ", "         "]),
        'N' => Some(vec!["  _   _ ", " | \\ | |", " |  \\| |", " | |\\  |", " |_| \\_|", "        ", "        "]),
        'O' => Some(vec!["   ___  ", "  / _ \\ ", " | | | |", " | |_| |", "  \\___/ ", "        ", "        "]),
        'P' => Some(vec!["  ____  ", " |  _ \\ ", " | |_) |", " |  __/ ", " |_|    ", "        ", "        "]),
        'Q' => Some(vec!["   ___  ", "  / _ \\ ", " | | | |", " | |_| |", "  \\___\\_\\", "        ", "        "]),
        'R' => Some(vec!["  ____  ", " |  _ \\ ", " | |_) |", " |  _ < ", " |_| \\_\\", "        ", "        "]),
        'S' => Some(vec!["  ____  ", " / ___| ", " \\___ \\ ", "  ___) |", " |____/ ", "        ", "        "]),
        'T' => Some(vec!["  _____ ", " |_   _|", "   | |  ", "   | |  ", "   |_|  ", "        ", "        "]),
        'U' => Some(vec!["  _   _ ", " | | | |", " | | | |", " | |_| |", "  \\___/ ", "        ", "        "]),
        'V' => Some(vec!["__     __", "\\ \\   / /", " \\ \\ / / ", "  \\ V /  ", "   \\_/   ", "         ", "         "]),
        'W' => Some(vec!["__        __", "\\ \\      / /", " \\ \\ /\\ / / ", "  \\ V  V /  ", "   \\_/\\_/   ", "            ", "            "]),
        'X' => Some(vec!["__  __", "\\ \\/ /", " \\  / ", " /  \\ ", "/_/\\_\\", "      ", "      "]),
        'Y' => Some(vec!["__   __", "\\ \\ / /", " \\ V / ", "  | |  ", "  |_|  ", "       ", "       "]),
        'Z' => Some(vec!["  _____", " |__  /", "   / / ", "  / /_ ", " /____|", "       ", "       "]),
        ' ' => Some(vec!["     ", "     ", "     ", "     ", "     ", "     ", "     "]),
        _ => Some(vec!["     ", " ??? ", "     ", " ??? ", "     ", "     ", "     "]),
    }
}
...
fn ivrit_glyph(ch: char) -> Option<Vec<&'static str>> {
    match ch.to_ascii_uppercase() {
        'A' => Some(vec!["  ___   ", " /   \\  ", "|  _  | ", "| | | | ", "|_| |_| "]),
        'B' => Some(vec!["______ ", "|   __)", "|  |_  ", "|   __)", "|______)"]),
        'C' => Some(vec![" _____ ", "( ___ )", "|  ___|", "| |___ ", " \\___/ "]),
        'D' => Some(vec!["______ ", "(  __  )", "| |  | |", "| |__| |", "(______)"]),
        'E' => Some(vec!["______ ", "|  ____|", "| |____ ", "|  ____|", "|______|"]),
        'F' => Some(vec!["______ ", "|  ____|", "| |____ ", "|  ____|", "|_|     "]),
        'G' => Some(vec![" _____ ", "( ___ )", "|   __| ", "| |___  ", " \\____| "]),
        'H' => Some(vec!["_    _ ", "| |  | |", "|_|__|_|", "| |  | |", "|_|  |_|"]),
        'I' => Some(vec!["______ ", " |  |  ", " |  |  ", " |  |  ", " |__|  "]),
        'J' => Some(vec!["  ____ ", "    |  ", "    |  ", " |  |  ", " |__|  "]),
        'K' => Some(vec!["_   __ ", "| | / /", "|  < < ", "| |\\  \\", "|_| \\_\\"]),
        'L' => Some(vec!["_      ", "| |     ", "| |     ", "| |____ ", "|______|"]),
        'M' => Some(vec!["__   __ ", "| |_| | ", "|  _  | ", "| | | | ", "|_| |_| "]),
        'N' => Some(vec!["__    _ ", "| \\  | |", "|  \\ | |", "| |\\ \\| |", "|_| \\__|"]),
        'O' => Some(vec![" _____ ", "|  _  |", "| |_| |", "|  _  |", "|_| |_|"]),
        'P' => Some(vec!["______ ", "|   __ )", "|  |__) ", "|   ___/", "|__|    "]),
        'Q' => Some(vec![" _____ ", "|  _  |", "| |_| |", "|  _\\_\\", "|_|  \\_\\"]),
        'R' => Some(vec!["______ ", "|   __ )", "|  |__) ", "|   __/ ", "|__|  \\ "]),
        'S' => Some(vec![" ____  ", "/  __\\ ", "\\___  \\", " ___/  /", "/_____/ "]),
